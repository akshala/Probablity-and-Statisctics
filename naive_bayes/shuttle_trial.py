...
totalDataFrame = pd.read_csv("/home/akshala/Documents/IIITD/P&S/Assignment/assignment3/dataSets/shuttle-landing-control_clean.csv")
...
for k in range(0,n):
	...
	if (k_probability_op_0 > k_probability_op_1 and k_output == 0) or (k_probability_op_0 <= k_probability_op_1 and k_output == 1):
		accuracy_count += 1
		print('OK, row = {}, k_probability_op_0 = {}, k_probability_op_1 = {}, k_output = {}, accuracy = {}'.format(k,k_probability_op_0,k_probability_op_1, k_output, accuracy_count/(k+1)))
	else:
		print('NOK, row = {}, k_probability_op_0 = {}, k_probability_op_1 = {}, k_output = {}, accuracy = {}'.format(k,k_probability_op_0,k_probability_op_1, k_output, accuracy_count/(k+1)))
